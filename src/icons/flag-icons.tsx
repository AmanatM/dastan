export const USFlagIcon = ({ size = 20 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} id="flag-icons-us" viewBox="0 0 640 480">
...
export const RUFlagIcon = ({ size = 20 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-ru" width={size} viewBox="0 0 640 480">
...
export const KGFlagIcon = ({ size = 20 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-kg" width={size} viewBox="0 0 640 480">
      <defs>
        <clipPath id="kg-a">
