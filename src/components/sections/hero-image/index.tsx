  ...
  return (
    <section className="relative h-screen overflow-hidden">
      <div className="flex flex-col lg:flex-row size-full">
        ...
        <div className="h-3/6 lg:h-auto lg:w-2/6 pt-[64px] flex items-center justify-start lg:p-20 p-4">
      ...
      <h1 className="absolute bottom-0 left-0 right-0 font-bold text-[170px] text-center text-nowrap max-w-full hidden lg:flex">
        DASTAN ABIKOV
      </h1>
    </section>
  );
