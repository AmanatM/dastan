...
export function Slider({ quotes, children }: { quotes: TestimonialsSlider["quotes"]; children: React.ReactNode }) {
        ...
        <div className="flex items-center gap-4 pl-5">
          ...
          <div className="pr-5">
            {author.company.image ? (
              <Image
                alt={author.company.image.alt ?? author.company.title}
